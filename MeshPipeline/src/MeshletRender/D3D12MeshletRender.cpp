...
const wchar_t* D3D12MeshletRender::c_meshFilename = L"..\\Assets\\city.bin";
const wchar_t* c_texturePath = L"..\\Assets\\HighwayRoadWet01_1K_BaseColor_2.png";
...
void D3D12MeshletRender::OnInit()
{
    ...
    m_camera.SetMoveSpeed(15000.0f);
...
void D3D12MeshletRender::LoadAssets()
{
    ...
    {
        //std::cout << mesh.LayoutDesc.NumElements  << "\n";
        //std::wstring wstr = std::to_wstring(mesh.LayoutDesc.NumElements);
...
void D3D12MeshletRender::OnUpdate()
{
    ...
    XMMATRIX world = XMMatrixScaling(10000, 10000, 10000) * XMMatrixTranslation(0.0f, 100.0f, 0.0f);
